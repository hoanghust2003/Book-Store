    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div className="flex items-center p-8 bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold text-gray-800 dark:text-gray-200">{data?.totalBooks}</span>
                  <span className="block text-gray-500 dark:text-gray-400">Products</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold text-gray-800 dark:text-gray-200">${data?.totalSales}</span>
                  <span className="block text-gray-500 dark:text-gray-400">Total Sales</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div>
                  <span className="inline-block text-2xl font-bold text-gray-800 dark:text-gray-200">{data?.trendingBooks}</span>
                  <span className="inline-block text-xl text-gray-500 dark:text-gray-400 font-semibold">(13%)</span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold text-gray-800 dark:text-gray-200">{data?.totalOrders}</span>
